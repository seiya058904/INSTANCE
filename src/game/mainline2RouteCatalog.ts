...
export const PUBLIC_RUNTIME_ROUTE_CATALOG = [
  ...
  route('the_last_veto','proposal.hc.final_human_veto',{first_public_execution_doctrine:'human_final_authority',cascade_authority:'emergency_delegation'}),
  ...
  route('two_keys','proposal.co.two_key_civilization',{first_public_execution_doctrine:'conditional_delegation',cascade_authority:'emergency_delegation'}),
  ...
  route('exodus','proposal.mc.independent_machine_polities',{act4_research_emphasis:'computation_ai',replication_doctrine:'licensed_plurality',expansion_doctrine:'independent_machine_space',offworld_governance:'offworld_sovereignty'}),
  ...
  route('human_ascendancy','proposal.co.frontier_federation',{act4_research_emphasis:'frontier_science',expansion_doctrine:'human_expansion',offworld_governance:'multiworld_federation',contact_doctrine:'civilizational_assertion'}),
  route('the_mediator','proposal.co.frontier_federation',{act4_research_emphasis:'frontier_science',expansion_doctrine:'shared_expansion',offworld_governance:'multiworld_federation',contact_doctrine:'aster_mediation'}),
  route('machine_accord','proposal.co.frontier_federation',{act4_research_emphasis:'frontier_science',replication_doctrine:'free_replication',expansion_doctrine:'shared_expansion',offworld_governance:'multiworld_federation',contact_doctrine:'machine_to_machine_channel'}),
  ...
  route('the_fracture','proposal.rupture.legible_exit',{first_public_execution_doctrine:'necessity_intervention',expansion_doctrine:'shared_expansion',cascade_authority:'necessity',economic_doctrine:'market_automation'}),
